...
const LanguagesPage = ({ data, meta }: ILanguagesPageProps) => {
  return (
    <PageContentLayout
      header={<PageHeaderLayout title="Languages" />}
      content={<Languages data={data} meta={meta} />}
    />
  );
};
...
const LanguagesPageLayout = (page: React.ReactNode) => (
  <AppLayout
    SubMenu={<SubMenu menuItem={MENU_ITEMS['SETTINGS']} subMenuItem={SETTINGS_ITEMS['LANGUAGES']} />}
