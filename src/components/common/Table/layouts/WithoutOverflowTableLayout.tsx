...
interface IWithoutOverflowTalbeLayoutProps {
...
const classes = {
  ...
  tableMargin: '-my-2 sm:-mx-6 lg:-mx-8',
  tablePadding: 'py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8',
  tableBox: 'shadow border-b border-gray-200 sm:rounded-lg',
...
const WithoutOverflowTalbeLayout = ({ headRow, rows, footer }: IWithoutOverflowTalbeLayoutProps) => {
  return (
...
export default WithoutOverflowTalbeLayout;
