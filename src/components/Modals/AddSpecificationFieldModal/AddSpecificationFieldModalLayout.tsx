...
const classes = {
  ...
  amountWrapper: 'flex flex-col',
  actionsWrapper: 'w-full flex justify-end flex-row space-x-4',
};

const AddSpecificationFieldModalLayout = ({ title, type, amount, actions }: IAddCheckoutFieldModalLayoutProps) => {
  return (
...
export default AddSpecificationFieldModalLayout;
