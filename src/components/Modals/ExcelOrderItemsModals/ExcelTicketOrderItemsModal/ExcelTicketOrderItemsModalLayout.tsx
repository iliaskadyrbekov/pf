...
interface IExcelTicketOrderItemsModalLayoutProps {
...
const ExcelTicketOrderItemsModalLayout = ({
  title,
  filters,
  form,
  actions,
}: IExcelTicketOrderItemsModalLayoutProps) => {
  return (
...
export default ExcelTicketOrderItemsModalLayout;
