...
interface IAddShopLanguageModalLayoutProps {
...
const AddShopLanguageModalLayout = ({ title, langSelect, actions }: IAddShopLanguageModalLayoutProps) => {
  return (
    <div className={classes.wrapper}>
      <p className={classes.title}>{title}</p>
      <div className={classes.border} />
      <div className={classes.inputsWrapper}>{langSelect}</div>
      <div className={classes.actionsWrapper}>{actions}</div>
    </div>
  );
};

export default AddShopLanguageModalLayout;
