...
interface IFilterSpecificationFieldProps<T, Props> {
  item: T;
  index: number;
...
const FilterSpecificationField = <T,>({
  item,
  index,
  headRow,
  moveRow,
}: IFilterSpecificationFieldProps<T, IFieldProps>) => {
...
export default FilterSpecificationField;
