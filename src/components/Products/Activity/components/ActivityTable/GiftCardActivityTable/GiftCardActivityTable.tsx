...
import { IGiftCardProduct, TProduct } from 'src/shared/interfaces/Product';
...
interface GiftCardActivityTableProps {
  products: TProduct[];
  activityId: string;
}

const GiftCardActivityTable = ({ products, activityId }: GiftCardActivityTableProps) => {
  ...
  const tableHeadRow = [
    ...
    {
      label: 'Price',
      accessor: (product: TProduct) => getPricing((product as IGiftCardProduct).pricing, shop?.currency.symbolNative),
    },
...
export default GiftCardActivityTable;
