...
interface IAppWithHorizontalSubMenuLayoutProps {
...
const classes = {
  ...
  componentsWrapper: 'flex flex-col h-full overflow-hidden',
  navigationWrapper: 'flex',
};

const AppWithHorizontalSubMenuLayout = ({ children, menuItem, SubMenu }: IAppWithHorizontalSubMenuLayoutProps) => {
  return (
    <React.Fragment>
      <HeadTag />
...
export default AppWithHorizontalSubMenuLayout;
